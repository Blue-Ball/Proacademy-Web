                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                @foreach($setting['category'] as $mainCategory)
                                    <li class="cat-li" onmouseover="this.style.borderColor='{{ $mainCategory->color }}'" onmouseleave="this.style.borderColor='transparent'">
                                            
                                        @if(count($mainCategory->childs)>0)
                                            <a class="dropdown-item">
                                                <img src="{{ $mainCategory->image }}" style="width:20px;height:20px;" />
                                                {{ $mainCategory->title }}                                            
                                            </a>
                                            <ul class="dropdown-menu drop-sub">
                                                @foreach($mainCategory->childs as $child)
                                                    <li class="cat-li">
                                                        <a class="dropdown-item" href="/category/{{ $child->class }}">
                                                            <img src="{{ $child->image }}" style="width:16px;height:16px;" />
                                                            {{ $child->title }}
                                                        </a>
                                                    </li>
                                                @endforeach
                                        ...
                                        @else
                                            <a class="dropdown-item" href="/category/{{ $mainCategory->class }}">
                                                <img src="{{ $mainCategory->image }}" style="width:20px;height:20px;" />
                                                {{ $mainCategory->title }}                                            
                                            </a>
                                        @endif
